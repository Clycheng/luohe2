	...
	$.fn.fullpage = function(options) {
		...
		*/
		...
		//trying to use fullpage without a selector?
			...
			showError('error', "Error! Fullpage.实例 needs to be initialized with a selector. For example: $('#myContainer').fullpage();");
		}
		...
		*/
		 ...
		 *
		 * http://blogs.sitepointstatic.com/examples/tech/mouse-wheel/2.1.栅格系统.html
		...
		* https://github.com/alvarotrigo/fullPage.实例/issues/194#issuecomment-34069854
		*/
		...
		/*
		* Destroys fullpage.实例 plugin events and optinally its html markup and styles
		*/
		$.fn.fullpage.destroy = function(all){
 		...
 		/*
		* Removes inline styles added by fullpage.实例
		*/
